...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        upload: function upload() {
            ...
            Nova.request().post('/nova-vendor/import-targets', formData).then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Import Targets")]),
      _vm._v(" "),
        ...
        _c("div", { staticClass: "card" }, [
          _c("div", { staticClass: "flex border-b border-40" }, [
            ...
            _c("div", { staticClass: "py-6 px-8 w-4/5" }, [
              ...
              _vm._v(" "),
              _c("span", { staticClass: "text-90 text-sm select-none" }, [
                _vm._v(_vm._s(_vm.csv ? _vm.csv.name : "no file selected"))
              ])
            ]),
            _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c(
      "label",
      {
        staticClass: "form-file-btn btn btn-default btn-primary select-none",
        attrs: { for: "file-csv" }
      },
      [_c("span", { attrs: { id: "file-csv-text" } }, [_vm._v("Choose File")])]
    )
  }
]
